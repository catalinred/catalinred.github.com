...
description: How to create a CSS3 dropdown menu that appears using a small animation when the user hovers over an element with the cursor.
categories:
- CSS
- HTML
- JavaScript
...
![CSS3 animated dropdown menu with multiple levels](/dist/uploads/2011/11/css3-animated-dropdown-menu-preview.png)
...
[![Animated CSS3 dropdown menu](/dist/uploads/2011/11/css3-menu-animation.gif)](/dist/uploads/2011/11/css3-animated-dropdown-menu-demo.html)
...
### Mini [CSS reset](/css-tips-and-tricks-you-should-always-use)
...
![Dark menu navigation wrapper](/dist/uploads/2011/11/css3-menu-wrapper.png)
...
![Inline main menu elements on a dark background](/dist/uploads/2011/11/css3-menu-elements.png)
...
So, this is how this works: Select an "a" element that is child of a "li" ; the "li" element must be a descendant of the "#menu". Read more about [CSS selectors](https://www.w3.org/TR/selectors-3/).
...
![CSS dropdown menu animation when the user hovers over an main menu element](/dist/uploads/2011/11/css3-menu-animation.gif)
...
![:first-child and :last-child list elements in a dropdown menu](/dist/uploads/2011/11/css3-dropdown-first-last-items.png)
...
![CSS3 dropdown menu as a hamburger menu on mobile displays](/dist/uploads/2011/11/css3-mobile-dropdown.png)
