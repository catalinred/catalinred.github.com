...
![::before and ::after pseudo-elements on HTML replaced elements](/dist/uploads/2012/06/css-generated-content-replaced-elements.png)
...
[What the Heck is Shadow DOM?](https://glazkov.com/2011/01/14/what-the-heck-is-shadow-dom/). That's exactly my first question that came up in my head when I first heard about this. All the above examples I mentioned are based on this WebKit only feature that allows controlling a shadow DOM subtree of an element.

I agree it might sound a little overwhelming, and that's why I recommend you to read [Dimitri Glazkov](https://glazkov.com/)'s article.
...
### [Roger Johansson](https://www.456bereastreet.com/)
...
>
> It would certainly be really cool to have
> - a) a solid definition
> - b) that definition to allow for content on replaced elements
...
While doing some research on this article, I reminded myself I read a while ago an article by Chris Coyier regarding [styling horizontal rules](https://css-tricks.com/simple-styles-for-horizontal-rules/). The `hr` is a replaced element, as Chris also states in that article. Now, the interesting part here is that the [pseudo-elements](/before-after-pseudo-elements/) work on `hr` element whilst they shouldn't. And this happens on all major browsers too. So, it's pretty interesting huh?
...
Also, [Divya Manian](http://nimbupani.com/) was so kind and made a more advanced [test](https://jsfiddle.net/nimbu/GvwVy/show/) for pseudo-elements on replaced elements.
...
Last but not least, a big **thanks to all the above people** who've responded to my initiative. You rock!